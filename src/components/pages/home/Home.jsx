  ...
  return (
    ...
    <div className='OurTeam'>
      ...
      <div className='member'>
        ...
        <p>Crafting sweets is a legacy from more than 100 years, was put together to create a brand - Janta sweet home by our founder. Trust, innovation and creativity are our core values</p>
        </div>
        <div className='m1'>
        ...
        <div className='m1'>
            ...
            <p>Janta Sweet Home provides safe and secure packing for your delicate items. We use the latest technology and equipment to pack your items and ensure that they reach their destination safely and securely.</p>
        </div>
      </div>
    </div>
